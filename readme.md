...
- [Braille](/English/US English.brl)
### Latin
```
OpenWindows License, Version 1.0
(C) 2022 OpenWindows Operating System Project
...
1. PROOEMIUM
   The OpenWindows License est licentia programmatis open-fontis;
   inter documenta. Distributionem fontis aperti adiuvat
   permittens distributionem software.
  
   Licentia Microsoft Windows est licentia proprietatis, et
   haec licentia creata est ad OpenWindows exstare ne
   Microsoft ab OpenWindows consilium petendam conatur.
  
   Haec licentia pro OpenWindows facta est. Etiam libero utendi
   OpenWindows License in your own software and documentation.

2. DISTRIBUTIO ET IMMUTATIO DECRETUM
   Vos liberi estis hanc programmatum imitari, distribuere et modificare cum or
   sine permissu, sub his conditionibus;
  
     o Licentia et (si available) notatio librariae danda est
       OMNES codices substantiales huius programmatis.
     o Non debes alteri licentiam mutare. Haec licentia manebit
       genda cum omnibus exemplaribus.
     o Si signum in productum adhibetur, nexum cum website vel Git repositum est
       gratum si fieri potest sed non requiritur.

3. PATENTS
   Patentes usus permittitur, modo patentes hoc programmate utentes non attentant
