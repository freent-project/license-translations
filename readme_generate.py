...
<!--
   ...
   Generation date (to fix CI errors with git): {datetime.datetime.now()}
-->
...
for file in sorted(glob.glob("*/*.license")):
  readme = readme + "- [" + os.path.basename(file).split(".")[0] + "](#" + quote(os.path.basename(file).split(".")[0].replace(" ", "-").lower()) + ")\n"
